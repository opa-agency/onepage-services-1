  ...
  <Container class="pt-20 pb-16 text-center lg:pt-32">
    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
      ...
      <span class="relative whitespace-nowrap text-blue-600">
        ...
        <span class="relative">ușor</span>
      </span>
      pentru întreprinderi mici.
    </h1>
    <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      Majoritatea software-ului de contabilitate este precis, dar greu de utilizat. Facem
      tranzacția opusă și sperăm că nu ești controlat.
    </p>
    ...
    <div class="mt-36 lg:mt-44">
      <p class="font-display text-base text-slate-900">
        De încredere de aceste șase companii până acum
      </p>
      <ul
        role="list"
      ...
      >
        <li v-for="(group, groupIndex) in logoGroups" :key="groupIndex">
          <ul
            role="list"
